...
function createChartData(apiInput) {
    ...
    for (i = 0; i < Object.keys(apiInput).length; i++) {
        ...
        data.datasets[0].data[i] = {
            ...
            o: jsonObject[Object.keys(jsonObject)[i]]["1. open"], 
            h: jsonObject[Object.keys(jsonObject)[i]]["2. high"], 
            l: jsonObject[Object.keys(jsonObject)[i]]["3. low"], 
            c: jsonObject[Object.keys(jsonObject)[i]]["4. close"]
        }
    }
    // console.log(data);
    return data;
